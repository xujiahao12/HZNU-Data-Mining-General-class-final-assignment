...
# 绘制混淆矩阵
def plot_confusion_matrix(cm, labels, save_path="./image/logreg/large/confusion_matrix.png"):
...
# 绘制预测图像
def plot_images(images, labels, preds, ncols=5, save_path="./image/logreg/large/25_images.png"):
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
if __name__ == '__main__':
    ...
    plot_confusion_matrix(cm, labels, save_path="./image/logreg/large/confusion_matrix.png")
    ...
    plot_images(images_sample, labels_sample, preds_sample, save_path="./image/logreg/large/25_images.png")
