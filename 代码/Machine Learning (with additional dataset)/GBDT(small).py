...
# 绘制混淆矩阵
def plot_confusion_matrix(cm, labels, save_path="./image/gbdt/small/confusion_matrix.png"):
...
# 绘制预测图像
def plot_images(images, labels, preds, ncols=5, save_path="./image/gbdt/small/25_images.png"):
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
if __name__ == '__main__':
    ...
    plot_confusion_matrix(cm, labels, save_path="./image/gbdt/small/confusion_matrix.png")
    ...
    for i in range(25):
        ...
        axes[i].axis("off")
    plt.tight_layout()
    plt.savefig("./image/gbdt/small/25_images.png")
    plt.show()
