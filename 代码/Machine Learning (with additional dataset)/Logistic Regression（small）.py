...
# 绘制混淆矩阵
def plot_confusion_matrix(cm, labels, save_path="./image/logreg/small/confusion_matrix.png"):
...
# 绘制预测图像
def plot_images(images, labels, preds, ncols=5, save_path="./image/logreg/small/25_images.png"):
    os.makedirs(os.path.dirname(save_path), exist_ok=True)
...
if __name__ == '__main__':
    ...
    # 将测试集数据转换为适配Logistic Regression的格式
    ...
    plot_confusion_matrix(cm, labels, save_path="./image/logreg/small/confusion_matrix.png")
    ...
    plot_images(images_sample, labels_sample, preds_sample, save_path="./image/logreg/small/25_images.png")
